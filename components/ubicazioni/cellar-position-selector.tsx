    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between text-sm">
        ...
        <div className="flex items-center gap-3 text-xs">
          ...
          <div className="flex items-center gap-1.5">
            <div className="h-3 w-3 rounded border-2 border-wine-600 dark:border-wine-500 bg-wine-200 dark:bg-wine-800"></div>
            <span className="text-gray-600 dark:text-slate-400">Selezionata</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="h-3 w-3 rounded bg-gray-300 dark:bg-slate-600"></div>
                  ...
                  <div className="flex gap-1">
                    {Array.from({ length: bottiglie }, (_, bottleIndex) => {
                      ...
                      return (
                        <button
                          ...
                          disabled={isOccupied}
                          className={`h-10 w-8 rounded border-2 transition-all flex items-center justify-center
                            ${
                              isOccupied
                                ...
                                : "border-wine-300 dark:border-wine-700 bg-wine-50 dark:bg-wine-900/30 hover:bg-wine-100 dark:hover:bg-wine-900/50 cursor-pointer"
                            }
                          `}
                          title={
                            isOccupied
                          ...
                          <svg
                            className={`h-5 w-5 ${
                              isOccupied
                                ...
                                : "text-wine-400 dark:text-wine-600"
                            }`}
                            fill="currentColor"
                            viewBox="0 0 24 24"
                          >
                    ...
                    {bottiglie < max_bottiglie &&
                      Array.from({ length: max_bottiglie - bottiglie }, (_, emptyIndex) => (
                        <div key={`empty-${emptyIndex}`} className="h-10 w-8"></div>
                      ))}
                  </div>
